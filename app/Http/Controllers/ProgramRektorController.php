...
class ProgramRektorController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            foreach ($programRektors as $index => $program) {
                ...
                foreach ($units as $unit) {
                    if (isset($unit['UnitID']) && in_array($unit['UnitID'], $pelaksanaIds)) {
                ...
                $penanggungJawabNama = '';
                foreach ($units as $unit) {
                    if (isset($unit['UnitID']) && $unit['UnitID'] == $program->PenanggungJawabID) {
    ...
    public function create()
    {
        ...
        public function store(Request $request)
        {
            ...
            // Verify that each unit has the required keys and build a clean array of UnitIDs
            $unitIds = [];
            foreach ($units as $unit) {
