<form action="{{ route('program-pengembangans.update', $programPengembangan->ProgramPengembanganID) }}" method="POST" class="modal-form" id="programPengembanganEditForm">
    @csrf
    @method('PUT')
...
<script>
document.getElementById('programPengembanganEditForm').addEventListener('submit', function(event) {
