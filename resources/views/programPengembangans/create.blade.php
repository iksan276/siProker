<form action="{{ route('program-pengembangans.store') }}" method="POST" class="modal-form" id="programPengembanganForm">
    @csrf
...
document.getElementById('programPengembanganForm').addEventListener('submit', function(event) {
