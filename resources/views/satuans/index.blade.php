            ...
            <table class="table table-bordered" id="satuanTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr class="{{ $satuan->NA == 'Y' ? 'bg-light text-muted' : '' }}">
                        ...
                        <td>
                            <button class="btn btn-info btn-circle btn-sm load-modal" data-url="{{ route('satuans.show', $satuan->SatuanID) }}" data-title="Detail Satuan">
                                <i class="fas fa-eye"></i>
                            </button>
                            <button class="btn btn-warning btn-circle btn-sm load-modal" data-url="{{ route('satuans.edit', $satuan->SatuanID) }}" data-title="Edit Satuan">
