<form action="{{ route('satuans.update', $satuan->SatuanID) }}" method="POST" class="modal-form" id="satuanEditForm">
    @csrf
    @method('PUT')
...
<script>
document.getElementById('satuanEditForm').addEventListener('submit', function(event) {
